      ...
      <div className="container">
        ...
        <div className="content">
            ...
            <div className="right">
              ...
              <div className="popularity">
                <div className="box">
                  ...
                  <p>10</p>
                  <span>
                    <i className="xi-caret-down-min cDown"></i>2
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="left">
              <PreventedAnchor>
                <figure>
                  ...
                  ></div>
                  <img src="./img/mainVisual/m01.jpg" alt="" />
                </figure>
              </PreventedAnchor>
            </div>
          ...
          <div className="des">
            <div className="left">
              ...
              <div className="storyline">
                <strong> 스토리 </strong>
                <p>
                  화학 교사 월터 화이트가 3기 암 진단을 받고 2년만 살 수 있게 되었을 때, 그는 잃을 것이
                  없다고 결심한다. 그는 뇌성마비를 앓고 있는 10대 아들과 아내와 함께 뉴멕시코에서 살고
                  있다. 그의 가족이 안전한 미래를 가질 것을 확신하기로 결심한 월터는 마약과 범죄의 경력을
                  시작한다. 그는 이전 제자들 중 한 명과 함께 필로폰을 제조하고 판매하기 시작하면서 이
                  새로운 세계에 대해 놀랄 만큼 능숙함을 입증한다.
                </p>
              </div>
              <div className="produce">
                ...
                <div className="stars">
                  ...
                  <ul className="box">
                    {STARINFO.map((el, idx) => {
                      return (
                        <li key={el.id} className={`${el.cn} ${el.cn + "0"}${idx + 1}`}>
                          <PreventedAnchor>
                            <figure></figure>
                            {el.name}
                          </PreventedAnchor>
                ...
                <div className="info">
                  ...
                  <PreventedAnchor>모든 혜택 이용하기</PreventedAnchor>
                </div>
              </div>
            </div>
          </div>
          <div className="topRate on">
            ...
            <p>Top rated TV #2 16개 수상 & Primetime Emmys 154개 수상 등 총합 247개의 수상</p>
